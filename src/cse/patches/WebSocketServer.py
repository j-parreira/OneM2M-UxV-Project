...
class WebSocketServer(object):
	...
	def _run(self) -> None:
		...
		"""
		# ping_interval=None disables keepalive pings to prevent
		# ConnectionClosedError on busy connections (benchmark @ 5 msg/s).
		# websockets 16.x default is 20s interval + 20s timeout — too aggressive
		# when the client (websockets 13.1 sync) is under heavy notification load.
